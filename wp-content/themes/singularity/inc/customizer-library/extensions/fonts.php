...
function customizer_library_get_all_fonts() {
	$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', __( 'Standard Fonts', 'singularity' ) ) ) );
	$standard_fonts = customizer_library_get_standard_fonts();
	$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', __( 'Google Fonts', 'singularity' ) ) ) );
...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'singularity' ),
		'cyrillic'     => __( 'Cyrillic', 'singularity' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'singularity' ),
		'devanagari'   => __( 'Devanagari', 'singularity' ),
		'greek'        => __( 'Greek', 'singularity' ),
		'greek-ext'    => __( 'Greek Extended', 'singularity' ),
		'khmer'        => __( 'Khmer', 'singularity' ),
		'latin'        => __( 'Latin', 'singularity' ),
		'latin-ext'    => __( 'Latin Extended', 'singularity' ),
		'vietnamese'   => __( 'Vietnamese', 'singularity' ),
	);
}
endif;
...
function customizer_library_get_standard_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'singularity' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'singularity' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'singularity' ),
